            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('our-team-img')?>" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                           <?php the_field('our-story-title1'); ?>
                        </div>
                        <div class="aboutus__text">
                          <?php the_field('our-story-text1'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('our-story-img1'); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('our-story-img2'); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                           <?php the_field('our-story-title2'); ?>
                        </div>
                        <div class="aboutus__text">
                          <?php the_field('our-story-text2'); ?> 
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('our-story-title3'); ?>
                        </div>
                        <div class="aboutus__text">
                           <?php the_field('our-story-text3'); ?> 
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('our-story-img3'); ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
                               ...
                               $my_posts = get_posts( [
                                 ...
                                 ?>      
                                  ...
                                  <li class="glide__slide">
                                        ...
                                        <?php the_field('the-review-author'); ?>
                                        </div>
                                        <div class="feedslider__text">
                                           <?php the_field('feedback-text'); ?>
                                        </div>
                                    </li>
